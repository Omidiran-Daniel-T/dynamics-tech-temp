      ...
      <div className="w-screen">
        ...
        <div className="flex flex-col justify-center items-center h-screen pt-10">
          ...
          <form className="flex flex-col">
            ...
            <div className="bg-white h-12 w-72 flex items-center pl-5 rounded-lg shadow-lg my-5">
            ...
            <button
              className="text-white bg-yellow-500 text-lg tracking-wide py-2 w-5/6 rounded-md m-auto my-10"
              onClick={() => {
                <Redirect to="/forgot-password-2" />;
              }}
            >
              RESET PASSWORD
            </button>
